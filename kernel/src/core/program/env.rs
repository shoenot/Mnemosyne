...
use crate::{core::object::invoke::InvocationError, memory::{HHDMOFFSET, vmo::{PagedBackingStore, Vmo}}};
...
impl ProcessEnvironment {
    pub fn inject(
        ...
        let phys_frame = stack_vmo.request_page(top_page_offset)
        ...
        if total_payload_size > NORMAL_PAGE_SIZE { return Err(InvocationError::OutOfMemory); }
